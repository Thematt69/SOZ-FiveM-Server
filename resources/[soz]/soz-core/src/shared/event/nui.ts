export enum NuiEvent {
    ...
    AdminMenuMapperModelSwapAdd = 'soz-core:nui:admin:mapper:swap-add',
    AdminMenuMapperModelSwapDelete = 'soz-core:nui:admin:mapper:swap-delete',
    AdminMenuMapperModelSwapTeleport = 'soz-core:nui:admin:mapper:swap-teleport',
    ...
    AdminMenuTornado = 'soz-core:nui:admin:tornado',
    AdminMenuTornadoMove = 'soz-core:nui:admin:tornado-move',
    AdminMenuTornadoFlash = 'soz-core:nui:admin:tornado-flash',
    AdminMenuPreviewFire = 'soz-core:nui:admin:preview-fire',
    AdminMenuFirePropagation = 'soz-core:nui:admin:fire-propagation',
    ...
    AdminMenuHalloweenUpdateGamePlayerExclusion = 'soz-core:nui:admin:halloween:update-game-player-exclusion',
    ...
    PlayerMenuHudSetGlassmorphismFpsLimit = 'soz-core:nui:player:menu:hud-set-glassmorphism-fps-limit',
    ...
    PlayerMenuVoipSetIntent = 'soz-core:nui:player:menu:voip-set-intent',
    ...
    JewelryShopEngraveItem = 'soz-core:client:shop:jewelry:engrave-item',
    ...
    HousingRemoveTenant = 'soz-core:nui:housing:remove-tenant',
    ...
    GangEditZoneSelectPropToCreate = 'soz-core:client:gang:edit-zone:select-create',
    GangEditZoneChoosePropToCreate = 'soz-core:client:gang:edit-zone:choose-create',
    GangEditZoneRequestDeleteProp = 'soz-core:client:gang:edit-zone:prop-delete',
    GangEditZoneSelectPlacedProp = 'soz-core:client:gang:edit-zone:select-edit',
    GangEditZoneChoosePlacedPropToEdit = 'soz-core:client:gang:edit-zone:choose-edit',
    GangEditZoneToggleMouseSelection = 'soz-core:client:gang:edit-zone:mouse',
    GangEditZoneTogglePipette = 'soz-core:client:gang:edit-zone:pipette',
    GangEditZoneSelectPropToRemove = 'soz-core:client:gang:edit-zone:select-remove',
    ...
    BusinessSmugglingAdminMenuLeaveZone = 'soz-core:client:business:smuggling:edit-zone:leave-zone',
    BusinessSmugglingAdminMenuZoneSelectElem = 'soz-core:client:business:smuggling:edit-zone:select-elem',
    BusinessSmugglingAdminMenuBlip = 'soz-core:client:business:smuggling:edit-zone:blips',
    BusinessSmugglingAdminMenuEnterZone = 'soz-core:client:business:smuggling:edit-zone:enter-zone',
    ...
    AdminDoorSetTarget = 'soz-core:client:door:set-target',
    ...
    // Inventory
    InventoryClose = 'soz-core:nui:inventory:close',
    ...
    PhoneSetPropModel = 'soz-core:nui:phone:set-prop-model',
    PhoneFlashLight = 'soz-core:nui:phone:flash-light',
    PhoneInsideInput = 'soz-core:nui:phone:inside-input',
    PhoneSimCardReset = 'soz-core:nui:phone:sim-card-reset',
    ...
    PhoneAppPhotosEnterCamera = 'soz-core:nui:phone:app-photos-enter-camera',
    PhoneAppPhotosExitCamera = 'soz-core:nui:phone:app-photos-exit-camera',
    ...
    PhoneAppWeatherFetchLongTermForecasts = 'soz-core:nui:phone:app-weather-fetch-long-term-forecasts',
    ...
    AdminCasinoUpdateHouseEdgeConfig = 'soz-core:nui:admin-casino:update-house-edge-config',
    AdminCasinoPokerSelect = 'soz-core:nui:admin-casino-poker:select',
    AdminCasinoPokerReset = 'soz-core:nui:admin-casino-poker:reset',
    AdminCasinoBlackjackSelect = 'soz-core:nui:admin-casino-blackjack:select',
    AdminCasinoBlackjackReset = 'soz-core:nui:admin-casino-blackjack:reset',
    AdminCasinoRouletteSelect = 'soz-core:nui:admin-casino-roulette:select',
    AdminCasinoRouletteReset = 'soz-core:nui:admin-casino-roulette:reset',
    AdminCasinoInsideTrackRun = 'soz-core:nui:admin-casino-inside-track:run',
    AdminCasinoInsideTrackReset = 'soz-core:nui:admin-casino-inside-track:reset',
    AdminCasinoLuckyWheelCleanVehicle = 'soz-core:nui:admin-casino-lucky-wheel:clean-vehicle',
